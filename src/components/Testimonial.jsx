      ...
      <div className="flex animate-loop-testimonials">
        <div className="flex">
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "Velora made my shopping experience so easy and enjoyable!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              ...
              <div>
                ...
                <p>
                  <span>Marketing Manager, ABC Corp</span>
                </p>
              </div>
            </div>
          </div>
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "I love the variety of products available at Velora!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              <div>
                <img
              ...
              <div>
                ...
                <p>
                  <span>Product Designer, XYZ Ltd</span>
                </p>
              </div>
            </div>
          </div>
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              ...
              <div>
                ...
                <p>
                  <span>Sales Executive, DEF Inc</span>
                </p>
              </div>
            </div>
          </div>
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "Fast shipping and great quality products every time!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              <div>
                <img
              ...
              <div>
                ...
                <p>
                  <span>Business Owner, GHI Co</span>
                </p>
              </div>
            </div>
          </div>
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "I keep coming back for more amazing deals!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              <div>
                <img
              ...
              <div>
                ...
                <p>
                  <span>Content Creator, JKL Media</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex">
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "Shopping at Velora is always a delightful experience!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              <img
                src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
          ...
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "I highly recommend Velora to all my friends!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              <img
                src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
          ...
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "Their products are top-notch and reasonably priced!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              <img
                src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
          ...
          <div className="mr-8 flex w-[25rem] min-w-[25rem] flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            ...
            <blockquote className="md:text-md">
              "Shopping here is a breeze, I love it!"
            </blockquote>
            <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
              <img
                src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
