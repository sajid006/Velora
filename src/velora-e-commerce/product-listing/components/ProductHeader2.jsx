        ...
        <div className="grid grid-cols-1 gap-y-8 md:grid-cols-[1fr_16rem] md:gap-x-12 md:gap-y-10 lg:gap-12 xl:grid-cols-[1fr_0.5fr] xl:gap-x-20">
          <div>
            ...
            <p>
              ...
              Each category is designed to help you find exactly what you're
              looking for.
            </p>
            ...
            <Tabs defaultValue="tab-details">
              ...
              >
                <p>
                  Our return policy is designed to be hassle-free. If you're not
                  completely satisfied, you can return your product within 30
                  days. We believe in making your shopping experience enjoyable.
                </p>
              </TabsContent>
              <TabsContent
                value="tab-shipping"
